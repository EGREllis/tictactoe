...
public class IndexHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        String cookieUsername = cookies.get(COOKIE_USERNAME_KEY);
        String cookiePassword = cookies.get(COOKIE_PASSWORD_KEY);
        if (userRepository.loadUser(cookieUsername, cookiePassword) != null) {
            ...
            String htmlTemplate = HandlerUtil.loadPageFromClasspath("html/blank_board.html");
